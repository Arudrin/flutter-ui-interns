          ...
          children: <Widget>[
            ...
            new ListTile(
              ...
              onTap: () {
                ...
                Navigator.of(context).push(new MaterialPageRoute(builder: (BuildContext context) => new OtherPage("REQUESTS")));
              },
            ),
            new ListTile(
              ...
              onTap: () {
                Navigator.of(context).pop();
                Navigator.of(context).push(new MaterialPageRoute(builder: (BuildContext context) => new OtherPage("CHENES")));
              },
            ),
            new Divider(),
            new ListTile(
